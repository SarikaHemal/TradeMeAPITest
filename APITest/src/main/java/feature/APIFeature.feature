...
Given I perform get operation for json request "v1/Categories/UsedCars"
...
Given I perform get operation for json request "v1/Categories/UsedCars"
And i can get satus code 200
Then I can get validate response body with "Kia"

@Automate
Scenario: Verify the details of Used car is displayed  
Given I perform GET operation with path parameter for car "v1/Categories/UsedCars/1"
